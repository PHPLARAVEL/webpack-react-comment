...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commentBox = __webpack_require__(159);
	...
	_reactDom2.default.render(_react2.default.createElement(_commentBox2.default, { url: "./api/comment.php" }), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commentList = __webpack_require__(161);

	var _commentList2 = _interopRequireDefault(_commentList);

	var _commentForm = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _comment = __webpack_require__(162);
	...
	exports.default = _react2.default.createClass({
		...
		render: function render() {
			var CommentNodes = this.props.data.map(function (comment) {
				return _react2.default.createElement(_comment2.default, { author: comment.author, key: comment.id, text: comment.text, time: comment.id });
			});
			return _react2.default.createElement(
				"div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = __webpack_require__(163);
	...
	exports.default = _react2.default.createClass({
	       ...
	       render: function render() {
	              return _react2.default.createElement(
	                     "div",
	                     { className: "comment", key: this.props.key },
	                     _react2.default.createElement(
	                            "div",
	                            { className: "title" },
	                            _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                   ...
	                                   _react2.default.createElement(
	                                          "i",
	                                          null,
	                                          this.getDateTime(this.props.time)
	                                   )
	                            )
	                     ),
	                     _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  handleFucosBlur: function handleFucosBlur(name) {
	    var _that = this;
	    var elObj = (0, _jquery2.default)('.commentForm .' + name);

	    elObj.focus(function () {
	      console.log((0, _jquery2.default)('.commentForm .' + name));
	      if (name == 'name') {
	        _that.setState({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'nameBox' },
	        _react2.default.createElement('input', { className: 'name', name: 'name', style: nameInputStyle, type: 'text', placeholder: 'Your name', value: this.state.author, onChange: this.handleAuthorChange })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'textBox' },
	        _react2.default.createElement('textarea', { className: 'content', name: 'content', style: contentInputStyle, type: 'text', placeholder: 'Say something...', value: this.state.text, onChange: this.handleTextChange })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'btnBox' },
	        _react2.default.createElement('input', { className: 'submitBtn', type: 'submit', value: 'POST' })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "*{\n    margin:0;\n    padding:0;\n}\nbody{\n    margin:0 auto;\n}\n#main{\n    margin:20px auto;\n    width: 960px;\n}\n.commentBox{\n    height: auto;\n}\n.commentBox .title{\n    height: 30px;\n    margin: 20px 0;\n    color: #33CC66;\n    line-height: 30px;\n    font-weight: normal;\n}\n.commentBox .commentList{\n    width: 860px;\n    margin: 0 20px;\n}\n\n.commentBox .commentList .comment{\n    margin:10px 0;\n    font-size:14px;\n    line-height: 30px;\n    border-bottom: dashed 1px #CCCCFF;\n    border-radius: 3px;\n}\n.commentBox .commentList .comment .title{\n    height: 30px;\n    color: #333;\n}\n.commentBox .commentList .comment .title .author{\n    font-weight: bolder;\n    padding: 0 10px;\n    float: left;\n}\n.commentBox .commentList .comment .title .time{\n    padding: 0 10px;\n    font-size:12px;\n    float: right;\n}\n.commentBox .commentList .comment .content{\n    width: 760px;\n    margin:0 20px;\n}\n.commentBox .commentList .comment .content .text{\n    font-weight: normal;\n    padding: 20px 10px;\n}\n\n.commentBox .commentForm{\n    width: 900px;\n    height: 150px;\n}\n.commentBox .commentForm .nameBox{\n    height: 30px;\n    margin: 10px 0;\n}\n.commentBox .commentForm .nameBox .name{\n    height: 30px;\n    line-height: 30px;\n    border:solid 1px #33CC66;\n    border-radius: 3px;\n    padding: 0 15px;\n}\n.commentBox .commentForm .textBox{\n    height: 90px;\n    width: 870px;\n}\n.commentBox .commentForm .textBox .content{\n    border:solid 1px #33CC66;\n    height: 80px;\n    width: 870px;\n    line-height: 20px;\n    border:solid 1px #33CC66;\n    border-radius: 3px;\n    padding: 0 15px;\n}\n.commentBox .commentForm .btnBox{\n    margin:0 auto;\n    width: 60px;\n    height:30px;\n}\n.commentBox .commentForm .btnBox .submitBtn{\n    background: #33CC66;\n    border: solid 1px #33CC66;\n    border-radius: 5px;\n    width: 60px;\n    height:30px;\n    text-align: center;\n}", ""]);
